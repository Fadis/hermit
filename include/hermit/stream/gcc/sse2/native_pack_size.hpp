#ifndef HERMIT_STREAM_GCC_SSE2_NATIVE_PACK_SIZE_HPP
#define HERMIT_STREAM_GCC_SSE2_NATIVE_PACK_SIZE_HPP
...
template<>
struct native_pack_size< float > : public boost::mpl::size_t< 4 > {};

template<>
struct native_pack_size< double > : public boost::mpl::size_t< 2 > {};
