          ...
          public boost::spirit::karma::grammar< Iterator, boost::posix_time::ptime() > {
            public:
              rfc1123_date() : rfc1123_date::base_type( root ) {
                ...
                date = ( -karma::char_ << dec_p << ' ' << month << ' ' << -karma::char_ << -karma::char_ << -karma::char_ << dec_p )[
                  ...
                  karma::_7 = phx::bind( &boost::gregorian::date::year, &karma::_val ),
                  phx::if_( karma::_7 < 1000ul )[
                    karma::_4 = '0'
                  ],
                  phx::if_( karma::_7 < 100ul )[
                    karma::_5 = '0'
                  ],
                  phx::if_( karma::_7 < 10ul )[
                    karma::_6 = '0'
                  ]
                ];
