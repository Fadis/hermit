...
/*          map_16 = ( karma::byte_( 0xde ) << karma::big_word )[
          ...
          map_32 = ( karma::byte_( 0xdf ) << karma::big_dword )[
            karma::_pass = boost::phoenix::size( karma::_val ) <= 0xFFFFFFFFul,
            karma::_1 = boost::phoenix::size( karma::_val ),
            karma::_a = boost::phoenix::size( karma::_val )
          ] << karma::repeat( karma::_a )[ named_value ][
 ...
 //         value_ = uint8_|uint16_|uint32_|uint64_|int8_|int16_|int32_|int64_|null_|bool_|float_|double_|raw|array|map;
      ...
      private: 
        ...
        boost::spirit::karma::rule< Iterator, std::vector< hermit::messagepack >(), boost::spirit::karma::locals< uint32_t > > array_short;
        boost::spirit::karma::rule< Iterator, std::vector< hermit::messagepack >(), boost::spirit::karma::locals< uint32_t > > array_16;
        boost::spirit::karma::rule< Iterator, std::vector< hermit::messagepack >(), boost::spirit::karma::locals< uint32_t > > array_32;
        ...
        boost::spirit::karma::rule< Iterator, std::map< hermit::messagepack, hermit::messagepack >(), boost::spirit::karma::locals< uint32_t > > map_short;
        boost::spirit::karma::rule< Iterator, std::map< hermit::messagepack, hermit::messagepack >(), boost::spirit::karma::locals< uint32_t > > map_data;
        boost::spirit::karma::rule< Iterator, std::map< hermit::messagepack, hermit::messagepack >(), boost::spirit::karma::locals< uint32_t > > map_16;
        boost::spirit::karma::rule< Iterator, std::map< hermit::messagepack, hermit::messagepack >(), boost::spirit::karma::locals< uint32_t > > map_32;
