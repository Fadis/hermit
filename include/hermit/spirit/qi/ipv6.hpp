      ...
      public:
        ipv6() : ipv6::base_type( root ) {
          ...
          ipv6_type1 = ( ipv6part >> "::" >> ipv6part >> ':' >> ipv4address )[
            qi::_pass = phx::size( qi::_1 ) + phx::size( qi::_2 ) < 6,
          ...
          ipv6_type6 = ( ipv6part >> "::" >> ipv6part )[
            qi::_pass = phx::size( qi::_1 ) + phx::size( qi::_2 ) < 8,
            phx::at_c< 0 >( qi::_val ) = qi::_1,
            phx::at_c< 1 >( qi::_val ) = qi::_2
          ];
          ipv6_type7 = ( "::" >> ipv6part )[
            qi::_pass = phx::size( qi::_1 ) < 8,
            phx::at_c< 1 >( qi::_val ) = qi::_1
          ];
          ipv6_type8 = ( ipv6part >> "::" )[
            qi::_pass = phx::size( qi::_1 ) < 8,
          ...
          ipv6address = (ipv6_type1|ipv6_type2|ipv6_type3|ipv6_type4|ipv6_type5|ipv6_type6|ipv6_type7|ipv6_type8|ipv6_type9|ipv6_type0 )[
            ...
            phx::at_c< 0 >( qi::_val ) = phx::at( qi::_a, 0 ),
            phx::at_c< 0 >( qi::_val ) <<= 16,
            phx::at_c< 0 >( qi::_val ) |= phx::at( qi::_a, 1 ),
            phx::at_c< 0 >( qi::_val ) <<= 16,
            phx::at_c< 0 >( qi::_val ) |= phx::at( qi::_a, 2 ),
            phx::at_c< 0 >( qi::_val ) <<= 16,
            phx::at_c< 0 >( qi::_val ) |= phx::at( qi::_a, 3 ),
            phx::at_c< 1 >( qi::_val ) = phx::at( qi::_a, 4 ),
            phx::at_c< 1 >( qi::_val ) <<= 16,
            phx::at_c< 1 >( qi::_val ) |= phx::at( qi::_a, 5 ),
            phx::at_c< 1 >( qi::_val ) <<= 16,
            phx::at_c< 1 >( qi::_val ) |= phx::at( qi::_a, 6 ),
            phx::at_c< 1 >( qi::_val ) <<= 16,
            phx::at_c< 1 >( qi::_val ) |= phx::at( qi::_a, 7 )
          ];
          root = ipv6address;
        }
      private:
